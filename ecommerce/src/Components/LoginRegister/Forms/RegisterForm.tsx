...
const RegisterForm: React.FC = () => {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            let res = await axios.post('http://localhost:5046/api/users/register', registerData);
            let user = res.data;
    ...
    return (
        <Container>
            {error && <h4 style={{color: 'red'}}>Error al registrar. Verifique los datos o si el correo ya existe.</h4>}
